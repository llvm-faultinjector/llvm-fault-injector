; ModuleID = '.\qsort-recursive-2-faultinject.ll'
...
.lr.ph39:                                         ; preds = %.lr.ph39.preheader, %tailrecurse
  %.tr3237 = phi i32 [ %31, %tailrecurse ], [ %1, %.lr.ph39.preheader ]
...
.lr.ph:                                           ; preds = %.lr.ph39, %27
  %indvars.iv = phi i64 [ %indvars.iv.next, %27 ], [ %7, %.lr.ph39 ]
  %.035 = phi i32 [ %.1, %27 ], [ %.tr3237, %.lr.ph39 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %14 = getelementptr inbounds i32, i32* %0, i64 %indvars.iv.next
  %15 = load i32, i32* %14, align 4, !tbaa !3
  %16 = tail call i32 @__faultinject_selected_target(i32 %.tr3237) #4
...
; <label>:21:                                     ; preds = %.lr.ph
  ...
  store i32 %26, i32* %24, align 4, !tbaa !3
  store i32 %25, i32* %14, align 4, !tbaa !3
  br label %27

; <label>:27:                                     ; preds = %.lr.ph, %21
  %.1 = phi i32 [ %22, %21 ], [ %.035, %.lr.ph ]
  %exitcond = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond, label %tailrecurse.loopexit, label %.lr.ph

tailrecurse.loopexit:                             ; preds = %27
...
tailrecurse:                                      ; preds = %tailrecurse.loopexit, %.lr.ph39
  ...
  %29 = load i32, i32* %.pre-phi41, align 4, !tbaa !3
  store i32 %29, i32* %8, align 4, !tbaa !3
  store i32 %28, i32* %.pre-phi41, align 4, !tbaa !3
  %30 = add nsw i32 %.0.lcssa, -1
  tail call void @qsort(i32* nonnull %0, i32 %.tr3237, i32 %30)
  %31 = add nsw i32 %.0.lcssa, 1
  %32 = icmp slt i32 %31, %2
  br i1 %32, label %.lr.ph39, label %tailrecurse._crit_edge
