; ModuleID = 'test-double-1-clang.ll'
...
define dso_local double @test(double) #1 {
...
; <label>:10:                                     ; preds = %5
  %11 = load double, double* %2, align 8, !tbaa !11
  %12 = fadd double %11, 1.000000e+01
  store double %12, double* %2, align 8, !tbaa !11
  %13 = load double, double* %2, align 8, !tbaa !11
  %14 = call double @__faultinject_selected_target(double %13)
  %15 = fcmp ogt double %14, 1.000000e+02
  br i1 %15, label %16, label %19

; <label>:16:                                     ; preds = %10
  %17 = load double, double* %2, align 8, !tbaa !11
  %18 = fdiv double %17, 1.000000e+01
  store double %18, double* %2, align 8, !tbaa !11
  br label %19
...
; <label>:20:                                     ; preds = %19
  ...
  %22 = add nsw i32 %21, 1
  store i32 %22, i32* %3, align 4, !tbaa !7
  br label %5

; <label>:23:                                     ; preds = %8
  %24 = load double, double* %2, align 8, !tbaa !11
  ret double %24
}
...
declare dso_local void @__marking_faultinject_double(double*) #3
...
declare double @__faultinject_selected_target(double)
