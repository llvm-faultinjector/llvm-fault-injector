...
; <label>:10:                                     ; preds = %5
  call void @__marking_faultinject_double(double* %2)
...
; <label>:15:                                     ; preds = %10
  %16 = load double, double* %2, align 8, !tbaa !11
  %17 = fdiv double %16, 1.000000e+01
  store double %17, double* %2, align 8, !tbaa !11
  br label %18
...
; <label>:22:                                     ; preds = %8
  %23 = load double, double* %2, align 8, !tbaa !11
  ret double %23
}
