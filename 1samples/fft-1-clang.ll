...
; <label>:46:                                     ; preds = %40
  call void @__marking_faultinject_intptr(i32* %9)
  %47 = bitcast %struct._cplx* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %47) #5
  %48 = load %struct._cplx*, %struct._cplx** %7, align 8, !tbaa !3
  %49 = load i32, i32* %9, align 4, !tbaa !7
  %50 = load i32, i32* %5, align 4, !tbaa !7
  %51 = add nsw i32 %49, %50
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds %struct._cplx, %struct._cplx* %48, i64 %52
  %54 = load double, double* @PI, align 8, !tbaa !11
  ...
  call void @make(%struct._cplx* sret %11, double 0.000000e+00, double %61)
  %62 = bitcast %struct._cplx* %12 to i8*
  %63 = bitcast %struct._cplx* %53 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %62, i8* align 8 %63, i64 16, i1 false), !tbaa.struct !16
  call void @mul(%struct._cplx* sret %10, %struct._cplx* %11, %struct._cplx* %12)
  %64 = load %struct._cplx*, %struct._cplx** %8, align 8, !tbaa !3
  %65 = load i32, i32* %9, align 4, !tbaa !7
  %66 = sdiv i32 %65, 2
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds %struct._cplx, %struct._cplx* %64, i64 %67
  %69 = bitcast %struct._cplx* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %69) #5
  %70 = load %struct._cplx*, %struct._cplx** %7, align 8, !tbaa !3
  %71 = load i32, i32* %9, align 4, !tbaa !7
  %72 = sext i32 %71 to i64
  %73 = getelementptr inbounds %struct._cplx, %struct._cplx* %70, i64 %72
  %74 = bitcast %struct._cplx* %14 to i8*
  %75 = bitcast %struct._cplx* %73 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %74, i8* align 8 %75, i64 16, i1 false), !tbaa.struct !16
  %76 = bitcast %struct._cplx* %15 to i8*
  %77 = bitcast %struct._cplx* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %76, i8* align 8 %77, i64 16, i1 false), !tbaa.struct !16
  call void @plus(%struct._cplx* sret %13, %struct._cplx* %14, %struct._cplx* %15)
  %78 = bitcast %struct._cplx* %68 to i8*
  %79 = bitcast %struct._cplx* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %78, i8* align 8 %79, i64 16, i1 false), !tbaa.struct !16
  %80 = bitcast %struct._cplx* %13 to i8*
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %80) #5
  %81 = load %struct._cplx*, %struct._cplx** %8, align 8, !tbaa !3
  %82 = load i32, i32* %9, align 4, !tbaa !7
  %83 = load i32, i32* %6, align 4, !tbaa !7
  %84 = add nsw i32 %82, %83
  %85 = sdiv i32 %84, 2
  %86 = sext i32 %85 to i64
  %87 = getelementptr inbounds %struct._cplx, %struct._cplx* %81, i64 %86
  %88 = bitcast %struct._cplx* %16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %88) #5
  %89 = load %struct._cplx*, %struct._cplx** %7, align 8, !tbaa !3
  %90 = load i32, i32* %9, align 4, !tbaa !7
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds %struct._cplx, %struct._cplx* %89, i64 %91
  %93 = bitcast %struct._cplx* %17 to i8*
  %94 = bitcast %struct._cplx* %92 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %93, i8* align 8 %94, i64 16, i1 false), !tbaa.struct !16
  %95 = bitcast %struct._cplx* %18 to i8*
  %96 = bitcast %struct._cplx* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %95, i8* align 8 %96, i64 16, i1 false), !tbaa.struct !16
  call void @plus(%struct._cplx* sret %16, %struct._cplx* %17, %struct._cplx* %18)
  %97 = bitcast %struct._cplx* %87 to i8*
  %98 = bitcast %struct._cplx* %16 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %97, i8* align 8 %98, i64 16, i1 false), !tbaa.struct !16
  %99 = bitcast %struct._cplx* %16 to i8*
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %99) #5
  %100 = bitcast %struct._cplx* %10 to i8*
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %100) #5
  br label %101

; <label>:101:                                    ; preds = %46
  %102 = load i32, i32* %5, align 4, !tbaa !7
  %103 = mul nsw i32 2, %102
  %104 = load i32, i32* %9, align 4, !tbaa !7
  %105 = add nsw i32 %104, %103
  store i32 %105, i32* %9, align 4, !tbaa !7
  br label %40

; <label>:106:                                    ; preds = %44
  br label %107

; <label>:107:                                    ; preds = %106, %4
  ret void
}
