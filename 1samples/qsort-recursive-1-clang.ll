...
; <label>:42:                                     ; preds = %30
  ...
  call void @swap(i32* %46, i32 %45, i32 %43)
  br label %47
...
; <label>:51:                                     ; preds = %26
  ...
  %54 = load i32*, i32** %6, align 8, !tbaa !3
  call void @swap(i32* %54, i32 %53, i32 %52)
  %55 = load i32, i32* %8, align 4, !tbaa !7
  %56 = sub nsw i32 %55, 1
  %57 = load i32, i32* %5, align 4, !tbaa !7
  %58 = load i32*, i32** %6, align 8, !tbaa !3
  call void @qsort(i32* %58, i32 %57, i32 %56)
  %59 = load i32, i32* %4, align 4, !tbaa !7
  %60 = load i32, i32* %8, align 4, !tbaa !7
  %61 = add nsw i32 %60, 1
  %62 = load i32*, i32** %6, align 8, !tbaa !3
  call void @qsort(i32* %62, i32 %61, i32 %59)
