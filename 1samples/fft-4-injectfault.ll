...
@0 = internal global i32 33554432
...
; <label>:6:                                      ; preds = %4
  ...
  %rfi = xor i32 %2, %xor_val
  call void @faultinjectmarked(i32 %rfi)
  store i32 0, i32* @0
  %11 = icmp sgt i32 %rfi, 0
...
; <label>:14:                                     ; preds = %14, %.lr.ph
  ...
  %.sroa.051.0..sroa_idx = getelementptr inbounds %struct._cplx, %struct._cplx* %1, i64 %15, i32 0
  %.sroa.051.0.copyload = load double, double* %.sroa.051.0..sroa_idx, align 8
  %.sroa.252.0..sroa_idx53 = getelementptr inbounds %struct._cplx, %struct._cplx* %1, i64 %15, i32 1
  %.sroa.252.0.copyload = load double, double* %.sroa.252.0..sroa_idx53, align 8
  %22 = fmul double %.sroa.051.0.copyload, 0.000000e+00
  %23 = fmul double %21, %.sroa.252.0.copyload
  ...
  %28 = fadd double %.sroa.043.0.copyload, %24
  %29 = fadd double %.sroa.244.0.copyload, %25
  %.sroa.046.0..sroa_idx = getelementptr inbounds %struct._cplx, %struct._cplx* %0, i64 %27, i32 0
  store double %28, double* %.sroa.046.0..sroa_idx, align 8
  %.sroa.448.0..sroa_idx49 = getelementptr inbounds %struct._cplx, %struct._cplx* %0, i64 %27, i32 1
  store double %29, double* %.sroa.448.0..sroa_idx49, align 8
  ...
  %34 = fadd double %24, %.sroa.033.0.copyload
  %35 = fadd double %25, %.sroa.234.0.copyload
  %.sroa.036.0..sroa_idx = getelementptr inbounds %struct._cplx, %struct._cplx* %0, i64 %33, i32 0
  store double %34, double* %.sroa.036.0..sroa_idx, align 8
  %.sroa.4.0..sroa_idx38 = getelementptr inbounds %struct._cplx, %struct._cplx* %0, i64 %33, i32 1
  store double %35, double* %.sroa.4.0..sroa_idx38, align 8
  %indvars.iv.next = add i64 %indvars.iv, %13
  %xor_val1 = load i32, i32* @0
  call void @faultinjectmarked(i32 %xor_val1)
  %rfi2 = xor i32 %2, %xor_val1
  call void @faultinjectmarked(i32 %rfi2)
  store i32 0, i32* @0
  %36 = sext i32 %rfi2 to i64
  %37 = icmp slt i64 %indvars.iv.next, %36
  br i1 %37, label %14, label %.loopexit

.loopexit:                                        ; preds = %14, %6, %4
  ret void
}
...
._crit_edge:                                      ; preds = %.lr.ph.epil, %._crit_edge.loopexit.unr-lcssa, %2
