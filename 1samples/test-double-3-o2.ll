; ModuleID = 'test-double-2-faultinject.ll'
...
; <label>:3:                                      ; preds = %3, %1
  ...
  %5 = tail call double @__faultinject_selected_target(double %4) #2
  %6 = fcmp ogt double %5, 1.000000e+02
  %7 = fdiv double %4, 1.000000e+01
  %.1 = select i1 %6, double %7, double %4
