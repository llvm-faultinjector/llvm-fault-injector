...
; <label>:10:                                     ; preds = %5
  call void @__marking_faultinject_float(float* %2)
  ...
  %17 = fcmp ogt double %16, 1.000000e+02
  br i1 %17, label %18, label %21

; <label>:18:                                     ; preds = %10
  %19 = load float, float* %2, align 4, !tbaa !11
  %20 = fdiv float %19, 1.000000e+01
  store float %20, float* %2, align 4, !tbaa !11
  br label %21
